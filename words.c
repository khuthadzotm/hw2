...
pthread_create(&thread1,NULL,&words,infile);
pthread_join(thread1, NULL);

pthread_create(&thread2,NULL,&words,infile);
pthread_join(thread2, NULL);

pthread_create(&thread3,NULL,&words,infile);
pthread_join(thread3, NULL);

//void * word(void* args)
pthread_create(&thread4,NULL,&words,infile);
